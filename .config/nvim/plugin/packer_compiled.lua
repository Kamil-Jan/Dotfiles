...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    loaded = true,
    path = "/home/kamil/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  gruvbox = {
    loaded = true,
    path = "/home/kamil/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/kamil/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/kamil/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["vim-easymotion"] = {
    loaded = true,
    path = "/home/kamil/.local/share/nvim/site/pack/packer/start/vim-easymotion",
